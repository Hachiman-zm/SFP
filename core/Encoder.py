...
class Analysis_mv_net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(2, out_channel_N, 3, stride=2, padding=1)
        torch.nn.init.xavier_normal_(self.conv1.weight.data, (math.sqrt(2 * (2 + out_channel_N) / (4))))
        ...
        self.conv4 = nn.Conv2d(out_channel_N, out_channel_N, 3, stride=1, padding=1)
        torch.nn.init.xavier_normal_(self.conv4.weight.data, math.sqrt(2))
        torch.nn.init.constant_(self.conv4.bias.data, 0.01)
        self.relu4 = nn.LeakyReLU(negative_slope=0.1)
        self.conv5 = nn.Conv2d(out_channel_N, out_channel_N, 3, stride=2, padding=1)
        ...
        self.conv6 = nn.Conv2d(out_channel_N, out_channel_N, 3, stride=1, padding=1)
        ...
        self.conv7 = nn.Conv2d(out_channel_N, out_channel_N, 3, stride=2, padding=1)
        ...
        self.conv8 = nn.Conv2d(out_channel_N, out_channel_M, 3, stride=1, padding=1)
